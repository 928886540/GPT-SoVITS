// GPT-SoVITS Tavo runtime part: 52_voice_subtitle_media.js
// Role: voice list loading, subtitle timeline rendering, and MediaSession updates.
// This fragment is concatenated by static/tavo.runtime.js; it is not a standalone script.
    ...
    var DEFAULT_AVATARS = {
      narrator: scriptAssetUrl("tavo.assets/narrator.png?asset_v=20260603-narrator-art-v30"),
    ...
    function showSubtitleNotice(titleText, detailText) {
      ...
      subBox.innerHTML = renderSubtitleNoticeHtml(titleText, detailText);
    }
