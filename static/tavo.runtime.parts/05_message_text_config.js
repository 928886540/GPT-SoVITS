    ...
    var lite = persistableHistoryTracks(tracks).map(function (t) {
      ...
      return {
        ...
        metrics: t.metrics ? {
          ...
          total_s: t.metrics.total_s,
          total_wall_s: t.metrics.total_wall_s,
          elapsed_s: t.metrics.elapsed_s,
          audio_duration_s: t.metrics.audio_duration_s,
          rtf: t.metrics.rtf,
          wall_rtf: t.metrics.wall_rtf,
          performance_mode: t.metrics.performance_mode,
          diffusion_steps: t.metrics.diffusion_steps,
          sample_steps: t.metrics.sample_steps,
          batch_size: t.metrics.batch_size,
          sample_rate: t.metrics.sample_rate || t.sampleRate || t.sample_rate,
          parallel_infer: t.metrics.parallel_infer,
          streaming_mode: t.metrics.streaming_mode,
          speed_factor: t.metrics.speed_factor,
          top_k: t.metrics.top_k,
          top_p: t.metrics.top_p,
          temperature: t.metrics.temperature,
          segments_total: t.metrics.segments_total,
          segments_done: t.metrics.segments_done,
          source_segments_total: t.metrics.source_segments_total
        } : null,
