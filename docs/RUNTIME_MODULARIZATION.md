...
{
  "schema": 1,
  "runtimeVersion": "20260602-sovits-bridge-v11",
...
- `static/tavo.runtime.manifest.json` 已新增，声明 21 个旧 parts 的 `id`、`file`、`phase`、`depends`，`runtimeVersion=20260602-sovits-bridge-v11`。
